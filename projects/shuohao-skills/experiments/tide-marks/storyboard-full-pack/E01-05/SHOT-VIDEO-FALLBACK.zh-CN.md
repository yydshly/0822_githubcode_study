...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她戴上耳机。；动作：连续爆音盖住整条音轨。 |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥拖动第一段降噪参数。 |
| 3 | f3.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 许知遥：“潮声太满，人声在下面。”（专注，自言自语） |

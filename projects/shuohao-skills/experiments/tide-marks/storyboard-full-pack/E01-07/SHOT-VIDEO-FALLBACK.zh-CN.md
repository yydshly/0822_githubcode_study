...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她从抽屉里取出一张兄妹旧照。；动作：许知遥把旧照立在屏幕边。 |
| 2 | f2.png | f3.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“哥，是你吗？”（极轻，第一次失去克制） |
| 3 | f3.png | f4.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她重新播放那段残缺录音。 |
| 4 | f4.png | 无 | 2.5s | 4s | 在动作完成点尾裁到 2.5s | 许潮：“开船的不是爸。”（录音，气息短促） |

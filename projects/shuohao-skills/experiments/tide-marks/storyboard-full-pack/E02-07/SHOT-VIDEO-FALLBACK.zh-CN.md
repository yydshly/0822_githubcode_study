...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：两人进入昏暗货仓。 |
| 2 | f2.png | f3.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 动作：后墙报警器亮起琥珀灯。；动作：蜂鸣与电台录音重叠。 |
| 3 | f3.png | 无 | 2s | 4s | 在动作完成点尾裁到 2s | 程野：“就是这个声音。”（确认） |

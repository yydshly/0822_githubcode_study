...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 5s | 5s | 可保留精确尾帧，无需裁切 | 动作：高嵩转身拍了拍锈蚀的钢门。；高嵩：“他后来签了字，因为他知道许潮上了船。”（替死者下结论） |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“我哥为什么会在货仓？”（不让他绕开） |
| 3 | f3.png | f4.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 高嵩：“他偷了电台，想学大人报险。”（语气里带着轻蔑） |
| 4 | f4.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 高嵩：“最后，他把自己送上了船。”（刻意放慢） |

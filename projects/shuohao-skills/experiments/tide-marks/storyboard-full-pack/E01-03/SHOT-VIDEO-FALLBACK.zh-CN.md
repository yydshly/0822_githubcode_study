...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她拿起电台检查烧融的外壳。；动作：电台扬声器又挤出一声短促喘息。 |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“这不是电流声。”（立刻警觉） |
| 3 | f3.png | 无 | 4s | 4s | 按设计时长输出 | 动作：许知遥把黄铜钥匙装进口袋。；动作：她抱起电台走出候船厅。 |

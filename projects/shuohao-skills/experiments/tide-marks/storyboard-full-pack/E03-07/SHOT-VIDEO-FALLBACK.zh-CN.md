...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥抱着电台快步回到修复台前。；动作：她插入已经保存的原始副本。 |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“蜂鸣之后还有人声。”（盯住波形） |
| 3 | f3.png | f4.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：程野关上房门。；动作：许知遥提高蜂鸣后的低频人声。 |
| 4 | f4.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 许潮：“爸被他们按在货仓里。”（录音，压低声音） |

...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：他走出货仓接起电话。；动作：程野重新蹲到消防柜前。 |
| 2 | f2.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 动作：他从夹层抽出油纸包裹的清单。；程野：“他怕的不是电台，是这个。”（压低声音） |

...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许潮：“七月十九，一点四十七。”（录音，远而破碎） |
| 2 | f2.png | f3.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 动作：程野靠近扬声器。；动作：规律蜂鸣再次穿过潮声。 |
| 3 | f3.png | 无 | 2.5s | 4s | 在动作完成点尾裁到 2.5s | 程野：“这是货仓防潮报警器。”（确认，语气发沉） |

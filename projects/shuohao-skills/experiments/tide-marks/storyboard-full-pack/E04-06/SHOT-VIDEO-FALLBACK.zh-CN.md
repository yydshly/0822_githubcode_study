...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：程野后退两步，手机仍举在胸前。；高嵩：“录到了什么？”（笑意已经消失） |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 程野：“够你解释很久。”（短促，转身前回答） |
| 3 | f3.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 动作：程野转身跑向候船厅，高嵩立即追了出去。 |

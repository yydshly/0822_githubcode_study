...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：当晚直到次日凌晨，许知遥回到临时修复室，把电台放在灰绿修复台中央。；动作：她用软刷清掉电池仓里的盐霜。 |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她接上实验电源。；动作：两层屏幕同时跳出密集波形。 |
| 3 | f3.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 许知遥：“先保原始轨，再做副本。”（专业，语速稳定） |

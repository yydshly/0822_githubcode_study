...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥把同一台摔裂电台放在联单旁；联单只铺在保育衬纸上，尚未装进透明袋。程野说：‘他留下证据，又回去救人。’ |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“高嵩把他的选择，改成了罪。”（重新稳住声音） |
| 3 | f3.png | f4.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 动作：程野打开手机里的残缺录音。；高嵩：“她的学籍和住处，都在我手里。”（手机残录，断续但可辨） |
| 4 | f4.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 高嵩：“要想保住女儿，就让他签。”（手机残录，尾句被杂音切断） |

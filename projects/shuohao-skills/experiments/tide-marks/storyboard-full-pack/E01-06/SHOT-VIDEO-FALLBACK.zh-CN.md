...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她把右声道单独放大。；动作：一个模糊男声从噪声里露出半句。 |
| 2 | f2.png | f3.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许潮：“开船的……”（录音，急促喘息） |
| 3 | f3.png | f4.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥猛地按下暂停。 |
| 4 | f4.png | 无 | 2.5s | 4s | 在动作完成点尾裁到 2.5s | 许知遥：“这个声音……”（失神，尾音发紧） |

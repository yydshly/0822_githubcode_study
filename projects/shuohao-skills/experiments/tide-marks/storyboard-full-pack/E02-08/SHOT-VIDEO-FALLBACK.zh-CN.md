...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥走到嵌墙消防柜前。 |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她把钥匙插进消防柜锁孔。；动作：消防柜门弹开。 |
| 3 | f3.png | f4.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“它开的是这里。”（意外） |
| 4 | f4.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 动作：程野取出发霉的值班日志。 |

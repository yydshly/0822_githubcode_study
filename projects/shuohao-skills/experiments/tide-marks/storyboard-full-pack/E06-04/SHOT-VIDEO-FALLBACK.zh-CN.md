...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 许知遥：“你怕的不是噪声，是时间。”（把音量推高） |
| 2 | f2.png | f3.png | 4.5s | 5s | 使用尾帧：整段匀速变速到 4.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：发动机启动声盖过现场的低语。；许潮：“高嵩拿了备用钥匙，亲自开船。”（录音里快速报告） |
| 3 | f3.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 高嵩：“那是个孩子胡说！”（指向音响） |

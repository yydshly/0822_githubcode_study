...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 5s | 5s | 可保留精确尾帧，无需裁切 | 程野：“你毁掉的，只是我们愿意让你看见的那份。”（站到许知遥身边） |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：高嵩转身指向黑暗中的货仓。；高嵩：“明早九点，拆迁启动。”（不再掩饰威胁） |
| 3 | f3.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 高嵩：“里面的湿纸，一张都留不住。”（目光落在程野的手机上） |

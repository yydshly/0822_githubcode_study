...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥注意到他的回避。；许知遥：“你还知道什么？”（冷下来） |
| 2 | f2.png | f3.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：程野握紧椅背。 |
| 3 | f3.png | 无 | 4s | 4s | 按设计时长输出 | 程野：“事故第二天，我捡到过半块船牌。”（停顿后承认） |

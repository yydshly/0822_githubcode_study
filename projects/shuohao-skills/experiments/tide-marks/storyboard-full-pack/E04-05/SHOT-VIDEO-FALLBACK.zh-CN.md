...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 4.5s | 5s | 使用尾帧：整段匀速变速到 4.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：门外的程野抬起手机，把收音口贴近门缝。；许知遥：“你连一个不能开口的孩子都要推过去。”（声线更低） |
| 2 | f2.png | f3.png | 5s | 5s | 可保留精确尾帧，无需裁切 | 高嵩：“我是在提醒你，查下去，你连最后的家也保不住。”（礼貌中露出威胁） |
| 3 | f3.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 动作：高嵩低头看见门缝下晃动的人影。；动作：高嵩一把拉开货仓门。 |

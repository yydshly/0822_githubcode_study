...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥摘下耳机站起来。 |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“责任书上写的是爸。”（冷静被愤怒顶开） |
| 3 | f3.png | f4.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她把责任书压到电台旁。 |
| 4 | f4.png | 无 | 2.5s | 4s | 在动作完成点尾裁到 2.5s | 许知遥：“你们谁在撒谎？”（盯着父亲签名） |

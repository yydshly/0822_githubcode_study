...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥攥紧耳机线。 |
| 2 | f2.png | f3.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“再说一遍。”（压住颤抖） |
| 3 | f3.png | f4.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她提高人声频段。；动作：波形里的最后两个音节变得清楚。 |
| 4 | f4.png | 无 | 2s | 4s | 在动作完成点尾裁到 2s | 许潮：“是高嵩。”（录音，清楚而急迫） |

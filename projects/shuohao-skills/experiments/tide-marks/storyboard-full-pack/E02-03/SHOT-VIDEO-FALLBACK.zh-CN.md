...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“不是船上的？”（迅速追问） |
| 2 | f2.png | f3.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 动作：程野摇头。；程野：“每三十秒一次，我从小听到大。”（笃定） |
| 3 | f3.png | f4.png | 4s | 4s | 可保留精确尾帧，无需裁切 | 动作：许知遥把两条时间写在同一张纸上。；许知遥：“哥哥那时还在岸上。”（压住激动） |
| 4 | f4.png | 无 | 3s | 4s | 在动作完成点尾裁到 3s | 程野：“至少有一份记录是假的。”（简短，回避她的目光） |

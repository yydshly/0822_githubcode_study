...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：许知遥保存刚刚修出的三段音频副本。 |
| 2 | f2.png | f3.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：她继续向后拖动未修复的音轨。 |
| 3 | f3.png | f4.png | 2.5s | 4s | 使用尾帧：整段匀速变速到 2.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：电台突然爆出规律蜂鸣。 |
| 4 | f4.png | 无 | 2.5s | 4s | 在动作完成点尾裁到 2.5s | 动作：黄铜钥匙随震动滑到未修复的波形屏下。 |

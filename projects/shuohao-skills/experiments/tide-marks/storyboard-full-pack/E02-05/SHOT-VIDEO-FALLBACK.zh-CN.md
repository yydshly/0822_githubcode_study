...
| ---: | --- | --- | ---: | ---: | --- | --- |
| 1 | f1.png | f2.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“船牌呢？”（立刻追问） |
| 2 | f2.png | f3.png | 3.5s | 4s | 使用尾帧：整段匀速变速到 3.5s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 动作：程野松开椅背。；程野：“被我扔回水里了。”（负疚，句尾收短） |
| 3 | f3.png | f4.png | 3s | 4s | 使用尾帧：整段匀速变速到 3s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 许知遥：“谁让你扔的？”（声音发硬）；动作：程野看向桌上的父亲旧照。 |
| 4 | f4.png | f5.png | 2s | 4s | 使用尾帧：整段匀速变速到 2s，禁止尾裁；仅首帧：可在动作完成点尾裁 | 程野：“许叔。”（很轻） |
| 5 | f5.png | 无 | 3.5s | 4s | 在动作完成点尾裁到 3.5s | 动作：许知遥抓起黄铜钥匙。；许知遥：“去货仓。现在。”（果断） |

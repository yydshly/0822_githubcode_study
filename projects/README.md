...
| Particles4All | `researching` | `f0ab7c2d` | [项目报告](particles4all/README.md) · [水中套圈原型](particles4all/WATER_RING_GAME.md) · [固定上游](particles4all/upstream/) · [证据](particles4all/EVIDENCE.md) | 基础研究已归档；按明确使用场景重启水中套圈可玩性验证 |
...
Particles4All 的基础研究、适用场景和边界仍保持归档；当前按既定重启规则，只针对“网页水中套圈”这一明确场景验证原生 torus、水压喷流、圆环位移和目标计分，因此索引状态恢复为 `researching`。

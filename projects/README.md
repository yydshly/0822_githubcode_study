...
| Particles4All | `archived` | `f0ab7c2d` | [项目报告](particles4all/README.md) · [水产品技术储备](particles4all/WATER_PRODUCT_TECH_RESERVE.md) · [固定上游](particles4all/upstream/) · [证据](particles4all/EVIDENCE.md) | 局部液体—刚体研究已归档；后续只由明确产品需求重启 |
...
Particles4All 已完成源库能力、局部扩展、水中套圈概念、性能边界和长期价值判断并归档。新增产品、游戏与开源技术储备用于未来选型；只有出现必须使用局部三维体积流体与刚体双向作用的明确产品需求时才重新启动。
